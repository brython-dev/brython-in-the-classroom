...
class vec:
  ...
  def __rmul__(self, other):                                                                                                                
      if isinstance(other, int) or isinstance(other, float):
         ...
         _v._set_vec(self._vec.multiply(other))
         return _v
      raise ImplementationError("multiplication of %s and vec is not implemented yet"  % type(other))
  ...
  def cross(self, other):
      _v=vec()
<<<<<<< HEAD
      _v._set_vec(self._vec.cross(other._vec))
=======
      _v.set_vec(self._vec.cross(other._vec))
>>>>>>> d051d77b98f493310b29711ca259cfe6f33771f5
      return _v
...
#some wrapper functions for convenience
def norm(r):
  if isinstance(r, (vec)):
         return r.norm()
  raise ImplementationError("norm of %s  is not implemented yet"  % type(r))

def mag2(r):
  if isinstance(r, (vec)):
         return r.mag2()
  raise ImplementationError("mag2 of %s  is not implemented yet"  % type(r))
