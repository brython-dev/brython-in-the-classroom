...
class arrow(primitive):
  def __init__(self, **kwargs):
      primitive.__init__(self, JSConstructor(window.glowscript.arrow), **kwargs)

class box(primitive):
  def __init__(self, **kwargs):
      primitive.__init__(self, JSConstructor(window.glowscript.box), **kwargs)

class cone(primitive):
  def __init__(self, **kwargs):
      primitive.__init__(self, JSConstructor(window.glowscript.cone), **kwargs)

class curve(primitive):
  def __init__(self, **kwargs):
      primitive.__init__(self, JSConstructor(window.glowscript.curve), **kwargs)
...
class cylinder(primitive):
  def __init__(self, **kwargs):
      primitive.__init__(self, JSConstructor(window.glowscript.cylinder), **kwargs)

class helix(cylinder):
  def __init__(self, **kwargs):
      primitive.__init__(self, JSConstructor(window.glowscript.helix), **kwargs)

class pyramid(primitive):
  def __init__(self, **kwargs):
      primitive.__init__(self, JSConstructor(window.glowscript.pyramid), **kwargs)
...
class sphere(primitive):
  def __init__(self, **kwargs):
      ...
      if (('radius' in kwargs) and ('size' not in kwargs) and (isinstance(kwargs['radius'],int) or isinstance(kwargs['radius'],float))):
             kwargs['size']=kwargs['radius']*vec(2,2,2)

      primitive.__init__(self, JSConstructor(window.glowscript.sphere), **kwargs)
...
class distinct_light:
  def __init__(self, **kwargs):
      self._dl=JSConstructor(window.glowscript.distant_light)(kwargs)

class local_light:
  def __init__(self, **kwargs):
      self._ll=JSConstructor(window.glowscript.local_light)(kwargs)

class draw:
  def __init__(self, **kwargs):
      self._draw=JSConstructor(window.glowscript.draw)(kwargs)

class label:
  def __init__(self, **kwargs):
      self._label=JSConstructor(window.glowscript.label)(kwargs)

def attach_trail(object, **kwargs):
    if isinstance(object, primitive):
       JSObject(window.glowscript.attach_trail)(object._prim, kwargs)
    else:
       JSObject(window.glowscript.attach_trail)(object, kwargs)
